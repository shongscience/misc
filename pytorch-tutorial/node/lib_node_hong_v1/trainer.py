...
class Trainer(nn.Module):
    ...
    def train_on_batch(self, *batch, device):
        ...
        # Ensure y_batch is of type Long only if it is of integer type
        if y_batch.dtype in {torch.int32, torch.int64, torch.int16, torch.int8}:
        ...
        # Move loss to CPU and convert to Python scalar
